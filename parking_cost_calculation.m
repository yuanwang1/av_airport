...
%parking fee from of SFO, as of 2018
max_per_day_short = 36; % max fee per day for domestic/international hourly parking 2018 22
max_per_day_long = 25;  % max fee per day for long term parking       25
% SFO has no economic parking garages         

fee_per_15min_short = 2; % fee per every 15 min 2018  2
fee_per_15min_long = 2;    %      1                           2
...
%calculating round-trip cost using fuel
for i=1:num_all_IDs
...
%calculating round-trip cost of electric vehicles
for i=1:num_all_IDs
    distance_cal = simulation_all(i,6);
    kwh_per_meters = kwh_per_mile*1.6;
    cost_charging(i,3) = distance_cal*kwh_per_meters*cost_per_kwh*2;
end

function [parking_over_parking_curbside_new, parking_revenue_out, percent_private_parking_new_by_mode] = main_iteration(parking_over_parking_curbside, percent_parking_and_curbside, AV_adoption_rate, id, percent_parking_mode, percent_com_resident_rental_com_visitor, enplanements, show_figure)
...
percent_com_resident = percent_com_resident_rental_com_visitor(1);
percent_rental = percent_com_resident_rental_com_visitor(2);
percent_com_visitor = percent_com_resident_rental_com_visitor(3);
percent_travel_mode = [percent_private_parking percent_curbside percent_com_resident percent_rental percent_com_visitor ];  %1. private parking, 2. curbside, 3. commercial vehicle resident, 4. rental car,  5. commercial vehicle tourist
...
fprintf('Number of parking for short term hourly: %f, daily %f, long term %f, economic %f\n', num_parking_mode1, num_parking_mode2, num_parking_mode3, num_parking_mode4);
...
for n=1:id %only result up to id needs to be computed 
    ...
    %parking_cost_calculation_by_changerate;
